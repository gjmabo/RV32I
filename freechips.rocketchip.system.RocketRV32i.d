...
run-asm-p-tests: $(addprefix $(output_dir)/, $(addsuffix .out, $(rv32mi-p-asm-tests) $(rv32uc-p-asm-tests) $(rv32ua-p-asm-tests) $(rv32ui-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED)/i )' $^ /dev/null | perl -ne 'if(/(.*)/){print "$$1\n\n"; exit(1) if eof()}'
run-asm-p-tests-debug: $(addprefix $(output_dir)/, $(addsuffix .vpd, $(rv32mi-p-asm-tests) $(rv32uc-p-asm-tests) $(rv32ua-p-asm-tests) $(rv32ui-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED)/i )' $(patsubst %.vpd,%.out,$^) /dev/null | perl -ne 'if(/(.*)/){print "$$1\n\n"; exit(1) if eof()}'
run-asm-p-tests-fst: $(addprefix $(output_dir)/, $(addsuffix .fst, $(rv32mi-p-asm-tests) $(rv32uc-p-asm-tests) $(rv32ua-p-asm-tests) $(rv32ui-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED)/i )' $(patsubst %.fst,%.out,$^) /dev/null | perl -ne 'if(/(.*)/){print "$$1\n\n"; exit(1) if eof()}'
run-asm-p-tests-fast: $(addprefix $(output_dir)/, $(addsuffix .run, $(rv32mi-p-asm-tests) $(rv32uc-p-asm-tests) $(rv32ua-p-asm-tests) $(rv32ui-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED)/i )' $^ /dev/null | perl -ne 'if(/(.*)/){print "$$1\n\n"; exit(1) if eof()}'

run-asm-tests: $(addprefix $(output_dir)/, $(addsuffix .out, $(rv32mi-p-asm-tests) $(rv32uc-p-asm-tests) $(rv32ua-p-asm-tests) $(rv32ui-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED)/i )' $^ /dev/null | perl -ne 'if(/(.*)/){print "$$1\n\n"; exit(1) if eof()}'
run-asm-tests-debug: $(addprefix $(output_dir)/, $(addsuffix .vpd, $(rv32mi-p-asm-tests) $(rv32uc-p-asm-tests) $(rv32ua-p-asm-tests) $(rv32ui-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED)/i )' $(patsubst %.vpd,%.out,$^) /dev/null | perl -ne 'if(/(.*)/){print "$$1\n\n"; exit(1) if eof()}'
run-asm-tests-fst: $(addprefix $(output_dir)/, $(addsuffix .fst, $(rv32mi-p-asm-tests) $(rv32uc-p-asm-tests) $(rv32ua-p-asm-tests) $(rv32ui-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED)/i )' $(patsubst %.fst,%.out,$^) /dev/null | perl -ne 'if(/(.*)/){print "$$1\n\n"; exit(1) if eof()}'
run-asm-tests-fast: $(addprefix $(output_dir)/, $(addsuffix .run, $(rv32mi-p-asm-tests) $(rv32uc-p-asm-tests) $(rv32ua-p-asm-tests) $(rv32ui-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED)/i )' $^ /dev/null | perl -ne 'if(/(.*)/){print "$$1\n\n"; exit(1) if eof()}'
